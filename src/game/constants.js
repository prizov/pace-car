...
export const SEAL_SPEED = 290;              // seal waddling speed
export const SEAL_FART_RADIUS = 110;        // green cloud radius
export const SEAL_FART_DURATION = 3000;     // ms cloud persists on track
export const SEAL_FART_COOLDOWN = 2600;     // ms between gas bursts
export const SEAL_FART_SLOW_MULT = 0.2;     // cars lose 80% of their speed
